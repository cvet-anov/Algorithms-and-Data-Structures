...
public class Heroes {
    ...
    public static void startHeroesGame(SLL<Card> firstFriendCards, SLL<Card> secondFriendCards) {
        ...
        SLLNode <Card> najdobra=secondFriendCards.getFirst();
        int power=prva.element.getPower()*prva.element.getNumAttacks();
        for (int i=0;i<5;i++){
        ...
        prva=firstFriendCards.getFirst();
        secondFriendCards.insertAfter(najdobra.element,secondFriendCards.getFirst().succ.succ);
        firstFriendCards.delete(najdobra);
    }
